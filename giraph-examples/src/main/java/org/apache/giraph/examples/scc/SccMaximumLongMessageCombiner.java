...
/**
 * Message combiner for Strongly Connected Components computation. This
 * combiners keeps the smallest message value as part of the graph coloring
 * phase.
 */
public class SccMaximumLongMessageCombiner extends
